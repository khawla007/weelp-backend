<x-emails.layouts.weelp>
    ...
    <h1 style="margin: 0 0 16px 0; color: #273F4E; font-size: 24px; font-weight: 600;">New Customized Itinerary Awaiting Approval</h1>
    ...
    <p style="margin: 0 0 24px 0; color: #435A67; font-size: 15px; line-height: 1.6;">
        A creator has submitted a new customized itinerary for your review. Please evaluate the content and approve or request changes.
    </p>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f2f7f5; border-radius: 8px; margin: 24px 0;">
        <tr>
            <td style="padding: 20px;">
                ...
                <p style="margin: 4px 0; color: #435A67; font-size: 14px;"><strong>Creator:</strong> {{ $creator->name }} ({{ $creator->email }})</p>
                <p style="margin: 4px 0; color: #435A67; font-size: 14px;"><strong>Status:</strong> <span style="color: #f59e0b;">Pending Approval</span></p>
                <p style="margin: 4px 0; color: #435A67; font-size: 14px;"><strong>Days:</strong> {{ $itinerary->schedules->count() }}</p>
                <p style="margin: 4px 0; color: #435A67; font-size: 14px;"><strong>Submitted:</strong> {{ $itinerary->created_at->format('M j, Y - g:i A') }}</p>
            </td>
        </tr>
    </table>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="padding: 24px 0 0 0; text-align: center;">
                <a href="{{ config('app.frontend_url') }}/dashboard/admin/creator-itineraries?status=pending_approval" class="email-button" target="_blank">Review Itinerary</a>
            </td>
        </tr>
    </table>
