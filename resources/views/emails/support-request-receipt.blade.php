<x-emails.layouts.weelp>
    ...
    <h1 style="margin: 0 0 16px 0; color: #273F4E; font-size: 24px; font-weight: 600;">We received your request</h1>

    <p style="margin: 0 0 16px 0; color: #435A67; font-size: 15px; line-height: 1.6;">
        Hello {{ $supportRequest->name }},
    </p>

    <p style="margin: 0 0 24px 0; color: #435A67; font-size: 15px; line-height: 1.6;">
        Our support team will review your question and reply by email.
    </p>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="padding: 8px 0 0 0; text-align: center;">
                <a href="{{ $supportRequest->page_url }}" class="email-button" target="_blank">View your trip</a>
            </td>
        </tr>
    </table>
