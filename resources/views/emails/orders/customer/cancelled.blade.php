<x-emails.layouts.weelp>
    ...
    <h1 style="margin: 0 0 16px 0; color: #273F4E; font-size: 24px; font-weight: 600;">Order Cancelled</h1>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f2f7f5; border-radius: 8px; margin: 24px 0;">
        <tr>
            <td style="padding: 20px;">
                <p style="margin: 0; color: #273F4E; font-size: 14px;"><strong>Total Paid:</strong> ₹{{ $order->payment->amount }}</p>
            </td>
        </tr>
    </table>
