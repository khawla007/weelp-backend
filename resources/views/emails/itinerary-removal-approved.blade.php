<x-emails.layouts.weelp>
    ...
    <h1 style="margin: 0 0 16px 0; color: #273F4E; font-size: 24px; font-weight: 600;">Itinerary Removal Confirmed</h1>
    ...
    <p style="margin: 0 0 24px 0; color: #435A67; font-size: 15px; line-height: 1.6;">
        Your request to remove <strong style="color: #273F4E;">"{{ $itinerary->name }}"</strong> has been approved. The itinerary is no longer visible on Explore.
    </p>

    <p style="margin: 0 0 24px 0; color: #435A67; font-size: 15px; line-height: 1.6;">
        You can create new itineraries at any time and share your travel ideas with the Weelp community.
    </p>
