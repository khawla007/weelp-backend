...
class CancellationRequestReceivedMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(subject: "Cancellation request #{$this->cancellationRequest->id} received");
    }

    public function content(): Content
    {
        return new Content(
            markdown: 'emails.orders.cancellation.received',
